...
export const en: Messages = {
    ...
    track: {
        ...
        about: 'About this track',
        prerequisites: 'Before this track',
        startingPoint: 'No previous track needed: this is a starting point.',
        outline: 'Track contents',
        readingTime: '{time} of reading',
        dedication: 'Estimated effort: {hours} h with practice',
        emptyTitle: 'This track has no published lessons yet',
        emptyDescription:
    ...
    lesson: {
        ...
        prerequisites: 'Worth reading first',
        skills: 'Skills it builds',
        resources: 'Go deeper',
        official: 'Official source',
        brokenLink: 'The last check could not find this link.',
        version: 'Version {version}, published on {date}',
        pager: 'Lesson navigation',
        previous: 'Previous',
        next: 'Next',
        backToTrack: 'Back to {track}',
        endOfTrack: 'This is the last lesson of the track.',
    },
    contentType: {
        CONCEPT: 'Concept',
        TUTORIAL: 'Tutorial',
